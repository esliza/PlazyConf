...
import com.stefany.plazyconf.view.adapter.SpeakerAdapter
import com.stefany.plazyconf.view.adapter.SpeakerListener
import com.stefany.plazyconf.viewmodel.SpeakersViewModel
...
class SpeakersFragment : Fragment(),SpeakerListener {
    ...
    override fun onSpeakerClicked(speaker: Speaker, position: Int) {
        ...
        findNavController().navigate(R.id.speakersDetailFragment, bundle)
    }
